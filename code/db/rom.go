...
//根据条件，查询多条数据
func (m *Rom) Get(showSubGame uint8, showHide uint8, pages int, platform uint32, menu string, keyword string, baseType string, basePublisher string, baseYear string, baseCountry string, baseTranslate string, baseVersion string, baseProducer string) ([]*Rom, error) {
