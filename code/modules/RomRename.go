...
func RomRename(id uint64, newName string) error {
	...
	infoMd5 := utils.GetRomMd5(newName, p, rom.BaseType, rom.BaseYear, rom.BaseProducer, rom.BasePublisher, rom.BaseCountry, rom.BaseTranslate, rom.BaseVersion, rom.BaseNameEn, rom.BaseNameJp, rom.BaseOtherA, rom.BaseOtherB, rom.BaseOtherC, rom.BaseOtherD, rom.Score, rom.Size)
