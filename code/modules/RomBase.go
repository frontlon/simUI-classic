...
func CoverRomBaseFile(platform uint32, newData map[string]*RomBase) error {
	...
	for _, v := range newData {
		...
		str := strings.Join([]string{v.Name, v.Producer, v.Publisher, v.Year, v.Type, v.Country, v.Translate, v.Version, v.NameEN, v.NameJP, v.OtherA, v.OtherB, v.OtherC, v.OtherD}, "")
